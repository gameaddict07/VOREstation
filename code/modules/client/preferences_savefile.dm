...
//	s_tone			= sanitize_integer(s_tone, -185, 34, initial(s_tone)) //Goodbye Skintone, Orbis
	r_skin			= sanitize_integer(r_skin, 0, 255, initial(r_skin))
	g_skin			= sanitize_integer(g_skin, 0, 255, initial(g_skin))
	b_skin			= sanitize_integer(b_skin, 0, 255, initial(b_skin))
	r_taur			= sanitize_integer(r_taur, 0, 255, initial(r_taur))
	g_taur			= sanitize_integer(g_taur, 0, 255, initial(g_taur))
	b_taur			= sanitize_integer(b_taur, 0, 255, initial(b_taur))
...
/datum/preferences/proc/save_character()
	...
	S["facial_green"]		<< g_facial
	S["facial_blue"]		<< b_facial
//	S["skin_tone"]			<< s_tone //Goodbye Skintone, Orbis
	S["skin_red"]			<< r_skin
	S["skin_green"]			<< g_skin
	S["skin_blue"]			<< b_skin
	S["taur_red"]			<< r_taur
