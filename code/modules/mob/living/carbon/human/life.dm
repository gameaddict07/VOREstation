				...
				if(stat != DEAD && digest_stomach) //According to vore.dm, digest_stomach being true means people should digest. // also: For some reason this can't be checked in the if statement below.
					if(iscarbon(M) || isanimal(M)) // If human or simple mob and you're set to digest.
						...
						if(M.stat == DEAD)
							...
							switch(digest_alert)
								if(1)
									src << "<span class='notice'>You feel [M]'s body succumb to your digestive system, which breaks it apart into soft slurry.</span>"
									M << "<span class='notice'>Your body succumbs to [src]'s digestive system, which breaks you apart into soft slurry.</span>"
								if(2)
									src << "<span class='notice'>You hear a lewd glorp as your stomach muscles grind [M] into a warm pulp.</span>"
									M << "<span class='notice'>[src]'s stomach lets out a lewd glorp as their muscles grind you into a warm pulp.</span>"
								if(3)
									src << "<span class='notice'>Your stomach lets out a rumble as it melts [M] into sludge.</span>"
									M << "<span class='notice'>[src]'s stomach lets out a rumble as it melts you into sludge.</span>"
								if(4)
									src << "<span class='notice'>You feel a soft gurgle as [M]'s body loses form in your stomach. They're nothing but a soft mass of churning slop now.</span>"
									M << "<span class='notice'>[src] feels a soft gurgle as your body loses form in their stomach. You're nothing but a soft mass of churning slop now.</span>"
								if(5)
									...
									switch(weight_msg)
										if(1)
											src << "<span class='notice'>Your stomach begins gushing [M]'s remains through your system, adding some extra weight to your thighs.</span>"
											M << "<span class='notice'>[src]'s stomach begins gushing your remains through their system, adding some extra weight to [src]'s thighs.</span>"
										if(2)
											src << "<span class='notice'>Your stomach begins gushing [M]'s remains through your system, adding some extra weight to your rump.</span>"
											M << "<span class='notice'>[src]'s stomach begins gushing your remains through their system, adding some extra weight to [src]'s rump.</span>"
										if(3)
											src << "<span class='notice'>Your stomach begins gushing [M]'s remains through your system, adding some extra weight to your hips.</span>"
											M << "<span class='notice'>[src]'s stomach begins gushing your remains through their system, adding some extra weight to [src]'s hips.</span>"
										if(4)
											src << "<span class='notice'>Your stomach begins gushing [M]'s remains through your system, adding some extra weight to your belly.</span>"
											M << "<span class='notice'>[src]'s stomach begins gushing your remains through their system, adding some extra weight to [src]'s belly.</span>"
										if(5)
											src << "<span class='notice'>Your stomach begins gushing [M]'s remains through your system, adding some extra weight to your tits.</span>"
											M << "<span class='notice'>[src]'s stomach begins gushing your remains through their system, adding some extra weight to [src]'s tits.</span>"
								if(6)
									src << "<span class='notice'>Your stomach groans as [M] falls apart into a thick soup. You can feel their remains soon flowing deeper into your body to be absorbed.</span>"
									M << "<span class='notice'>[src]'s stomach groans as you falls apart into a thick soup. Your remains soon flow deeper into [src]'s body to be absorbed.</span>"
								if(7)
									src << "<span class='notice'>Your gut kneads on every fiber of [M], softening them down into mush to fuel your next hunt.</span>"
									M << "<span class='notice'>[src]'s gut kneads on every fiber of your body, softening you down into mush to fuel their next hunt.</span>"
								if(8)
									src << "<span class='notice'>Your belly churns [M] down into a hot slush. You can feel the nutrients coursing through your digestive track with a series of long, wet glorps.</span>"
									M << "<span class='notice'>[src]'s belly churns you down into a hot slush. Your nutrient-rich remains course through their digestive track with a series of long, wet glorps.</span>"
								if(9)
						...
						if(!(M.status_flags & GODMODE))
							...
							if(TFchance == 1)
								...
								if(TFmodify == 2 && P.r_hair != src.r_hair && P.g_hair != src.g_hair && P.b_hair != src.b_hair && P.r_skin != src.r_skin && P.g_skin != src.g_skin && P.b_skin != src.b_skin)
									...
									P.g_hair = src.g_hair
									P.g_facial = src.g_hair
									P.b_hair = src.b_hair
									P.b_facial = src.b_hair
									P.r_skin = src.r_skin
									P.g_skin = src.g_skin
									P.b_skin = src.b_skin
									P.h_style = "Bedhead"
