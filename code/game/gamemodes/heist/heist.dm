...
/datum/game_mode/heist/announce()
	...
	world << "<B>An unidentified bluespace signature has slipped past the Daedalus and is approaching [station_name()]!</B>"
...
/datum/game_mode/proc/greet_vox(var/datum/mind/raider)
	...
	raider.current << "\blue The Vox are a race of cunning, sharp-eyed nomadic raiders and traders endemic to the frontier and much of the unexplored galaxy. You and the crew have come to the V.O.R.E. for plunder, trade or both."
