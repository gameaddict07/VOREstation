...
/datum/poster/bay_19
	...
	name = "Respect the Unathi"
	desc = "This poster depicts a well dressed looking Unathi receiving a prestigious award from a human. It appears to espouse greater co-operation and harmony between the two races."
